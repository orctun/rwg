...
game.scene.menu = function () {
	...
	//ship
	game.create.item ({ block: false, float: 1, h: 50, i: 'sail', w: 50, weight: 1, x: 900, y: 200 }).load ();
	game.create.item ({ block: false, float: 1, h: 50, i: 'sail', w: 50, weight: 1, x: 900, y: 300 }).load ();
	...
	game.create.item ({ block: true, float: -1, h: 25, i: 'bag', w: 50, weight: 1, x: 500, y: 100 }).load ();
}
